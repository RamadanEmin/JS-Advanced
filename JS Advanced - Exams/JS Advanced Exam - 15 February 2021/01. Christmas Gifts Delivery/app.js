function solution() {
    ...
    const sentGiftSection = document.querySelector('.container :nth-child(3) ul');
    ...
    function addGift() {
        ...
        sendBtn.addEventListener('click', () => sendToGiftSection(li, sentGiftSection, sendBtn, discardBtn));
